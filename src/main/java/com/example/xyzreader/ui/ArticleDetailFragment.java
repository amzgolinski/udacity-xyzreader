...
public class ArticleDetailFragment extends Fragment implements
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    mScrollView =
      (ObservableScrollView) mRootView.findViewById(R.id.scrollview);
    ...
    mScrollView.setCallbacks(new ObservableScrollView.Callbacks() {
      ...
      public void onScrollChanged() {
        ...
        getActivityCast()
          .onUpButtonFloorChanged(mItemId, ArticleDetailFragment.this);
        mPhotoContainerView.setTranslationY(
          (int) (mScrollY - mScrollY / PARALLAX_FACTOR)
        );
        updateStatusBar();
      }
    });
